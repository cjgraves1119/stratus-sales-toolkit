...
| **daily-task-engine-v1-9** | Interactive HTML dashboard output (default) with card/compact/kanban views, inline email editing, batch approve/skip/reject, Send to Claude integration, dark mode, and chat table fallback. Includes canonical Zoho query, IR01 batch pre-filter, sub-agent verbosity cap, DR01 closed-won auto-close, embedded voice/style guide, and Phase 3 spacing+style gate |
