...
0. Google Calendar morning briefing — show today's meetings, attendees, and deal overlaps
...
Follow the `daily-task-engine-v1-9` skill exactly. Never batch Zoho and Pipedream calls in the same parallel block.
